        ...
        <Box minH={'100vh'} pb={'5rem'}>
            ...
            <Container px={0} maxW={'container.md'}>
                ...
                <Box mx={'auto'}>
                    ...
                    >
                        <Image
                            src={'https://billupassets.blob.core.windows.net/rewards/sample/details-banner.png'}
                            priority={'true'}
                            placeholder={'blur'}
                            width={'568'}
                            height={'824'}
                        ...
                        >
                            ...
                            <Text my={4}>
                                ...
                                16.58cm(6.53) FHD+ IPS Display,Qualcomm® Snapdragon™ 662
                                Up to 128GB UFS 2.2 Storage,18W Fast Charge (22.5W In-box)
                                Corning® Gorilla® Glass 3, Stereo Speakers
                            </Text>
                            ...
                            <Text  mt={4}>
                                ...
                                commodo consequat. Duis autem vel eum iriure dolor in hendr
